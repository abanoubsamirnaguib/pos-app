...
@section('title')
@lang('site.edit_order') @lang('site.clients') 
@endsection
                                            ...
                                            <div id="{{ $order->created_at->format('d-m-Y-s') }}" class="panel-collapse collapse">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <ul class="list-group">
                                                        ...
                                                        <li class="list-group-item bg-aqua text-bold">{{ $product->name }}</li>
                                                        <li class="list-group-item">quantity = {{ $product->pivot->quantity }}</li>
                                                        <li class="list-group-item">Total Price = {{ number_format($product->pivot->quantity * $product->sale_price, 2) }}</li>
