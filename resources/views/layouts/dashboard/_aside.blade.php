    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            ...
            <div class="pull-left info">
                ...
                <a href="{{route('dashboard.users.welcome')}}"><i class="fa fa-circle text-success"></i> {{ auth()->user()->hasRole('super_admin')?"super_admin":"admin" }}</a>
            </div>
        </div>
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            {{-- <li><a href="{{ route('dashboard.users.welcome') }}"><i class="fa fa-users"></i><span>@lang('site.users')</span></a></li> --}}
            ...
            <li><a href="{{ route('dashboard.users.welcome') }}"><i class="fa fa-th"></i><span>@lang('site.users')</span></a></li>
            @endif --}}
